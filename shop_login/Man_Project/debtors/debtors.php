...
<div class="disbox" >
	...
	<div class="disbox" >
	<div style="padding-left:40px; padding-top:0px;">
	<a href="request.php" class="art-button" style="width:80%; height:50px; align:center; "><h3> Make Request</h3></a>
</div>	
	</div>
	
	<div class="disbox" >
	<div style="padding-left:40px; padding-top:0px;">
	<a href="confirm.php" class="art-button" style="width:80%; height:50px; align:center; "><h3> Approve Requests</h3></a>
</div>	
	</div>
